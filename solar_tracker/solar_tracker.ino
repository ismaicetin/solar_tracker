...
void setup() {
  ...
  sagsolStepper.setSpeed(5);
  ilerigeriStepper.setSpeed(5);
...
// stepper do a full 360 degrees
// sagsolStepper.step(stepsPerRevolution);
// ilerigeriStepper.step(stepsPerRevolution);
